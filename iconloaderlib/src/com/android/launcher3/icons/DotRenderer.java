...
public class DotRenderer {
    ...
    // The outline width is defined as a percentage of the dot radius.
    // TODO: check with UX if we need to adjust the outline width.
    private static final float OUTLINE_WIDTH_PERCENTAGE = 0.15f;
    ...
    private final Paint mOutlinePaint = new Paint(ANTI_ALIAS_FLAG | FILTER_BITMAP_FLAG);
    ...
    public DotRenderer(int iconSizePx) {
        ...
        mOutlinePaint.setStrokeWidth(Math.round(mCircleRadius * OUTLINE_WIDTH_PERCENTAGE));
        mDrawnRadius = mCircleRadius;
    }
    ...
    public void draw(Canvas canvas, DrawParams params) {
        ...
        mOutlinePaint.setColor(params.mOutlineColor);
        ...
        canvas.drawCircle(0, 0, mCircleRadius, mOutlinePaint);
        canvas.restore();
    }
    ...
    public static class DrawParams {
        ...
        /** The color to use for the dot outline. */
